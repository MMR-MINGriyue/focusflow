...
const OptimizedTimer: React.FC<OptimizedTimerProps> = ({
  onStateChange,
  className = ''
}) => {
  ...
  // 获取环境适配器
  const environmentAdapter = AdapterFactory.getEnvironmentAdapter();
  ...
  }, { component: 'OptimizedTimer', action: 'toggleTimer' });
  ...
  return (
    <TooltipProvider>
      <div className={`space-y-6 ${className}`}>
        {/* 主容器使用Card组件 */}
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm w-full max-w-md mx-auto">
